...
console.log('00 · Point de départ couplé : JSON, règle métier, représentation du stockage');
const request = { boardgameName: 'Brass: Birmingham', players: ['Alice', 'Bob'] };
...
console.log('Un joueur → refus attendu. Aucune écriture en base à cette étape.');
